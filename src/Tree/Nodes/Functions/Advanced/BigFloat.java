package Tree.Nodes.Functions.Advanced;
 ...
 *   </ul>
 * </li>
 * <li>equalTo and Hashcode methods:
 *   <ul>
 *   <li><code>equalTo(Object)</code> that returns whether two <code>BigFloat</code> values are mathematically the same</li>
 *   <li><code>hashCode()</code> consistent with <code>equalTo(Object)</code></li>
 *   </ul>
 * </li>
...
public class BigFloat implements Comparable<BigFloat> {
	...
	public boolean equals(Object obj) {
		...
		//return Objects.equalTo(value, other.value) && Objects.equalTo(context, other.context);
	}
